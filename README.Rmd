...
* 1d, 2d tensor Wavelet Transform Periodized Orthogonal (FTWT_PO, ITWT_PO)
* 1d Translation Invariant Forward Wavelet Transform (FWT_TI, IWT_TI, also know as redundant wavelet transform, maximal overlap wavelet transform, undecimated wavelet transform or stationary wavelet transform)
